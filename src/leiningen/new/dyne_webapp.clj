...
(defn dyne-webapp
  ...
  ([name]
   (dyne-webapp name (.get (java.util.Calendar/getInstance) (java.util.Calendar/YEAR)) "TODO:"))
  ([name year description]
   (println "Creating a Dyne webapp called " name " started on year " year " which will: " description)
   (let [data {:name name
               :year year
